...
- **[AKF](https://github.com/HMAKT99/AKF)** [![GitHub Repo stars](https://img.shields.io/github/stars/HMAKT99/AKF?logo=github&label=&style=social)](https://github.com/HMAKT99/AKF) - Open-source CLI for AI output compliance. Stamps files with trust scores, source provenance, and transparency metadata. One-command audit against EU AI Act Art. 50, SOX, HIPAA, GDPR, NIST AI RMF, ISO 42001. 20+ file formats. ([Docs](https://akf.dev) • [Demo](https://huggingface.co/spaces/HANAKT19/eu-ai-act-check))
