...
- [NIST - SP 800-218A: Secure Software Development Practices for Generative AI & Dual-Use Foundation Models (SSDF Community Profile)](https://www.nist.gov/itl/comments-nist-sp-800-218a-secure-software-development-practices-generative-ai-and-dual-use) - Community profile of NIST’s SSDF tailored to GenAI/foundation models: adds AI-specific tasks, roles, and artifacts across the model lifecycle (pre-train, fine-tune, integrate, deploy), with guidance on data/model provenance, evaluation & red teaming, supply chain assurance, and incident response; use alongside SP 800-218 and the NIST AI RMF.
