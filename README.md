...
- **[Polaxis](https://github.com/nishant6118/Polaxis-SDK-MCP)** [![GitHub Repo stars](https://img.shields.io/github/stars/nishant6118/Polaxis-SDK-MCP?logo=github&label=&style=social)](https://github.com/nishant6118/Polaxis-SDK-MCP) - Runtime firewall for AI agents and LLM pipelines. Intercepts every tool call and blocks prompt injection (99.0%), PII exfiltration (98.9%), credential leaks (100%), memory poisoning (98.9%), and authority impersonation (100%) before execution. 7-layer stack: sub-millisecond regex scan → LLM semantic eval → policy engine. Python SDK + MCP server. [[Benchmark](https://polaxis.io/benchmark)] [[polaxis.io](https://polaxis.io)]
