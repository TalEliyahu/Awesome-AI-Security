...
- [NIST - SP 800-218A: Secure Software Development Practices for Generative AI & Dual-Use Foundation Models (SSDF Community Profile)](https://www.nist.gov/itl/comments-nist-sp-800-218a-secure-software-development-practices-generative-ai-and-dual-use) - Applies SSDF practices to GenAI and dual-use foundation models; clarifies deltas vs. SP 800-218 (SSDF 1.1). ([PDF](https://downloads.regulations.gov/NIST-2024-0001-0040/attachment_1.pdf))
