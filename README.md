...
- **[prompt-injections-benchmark](https://huggingface.co/datasets/qualifire/prompt-injections-benchmark)**  
...
- **[prompt-injection](https://huggingface.co/datasets/jayavibhav/prompt-injection)**  
...
- **[gentelbench-v1](https://huggingface.co/datasets/GenTelLab/gentelbench-v1)**  
  [![HF downloads](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fhuggingface.co%2Fapi%2Fdatasets%2FGenTelLab%2Fgentelbench-v1&query=downloads&label=HF%20downloads)](https://huggingface.co/datasets/GenTelLab/gentelbench-v1) General safety/robustness benchmark (~177k rows) with jailbreak-style prompts plus benign controls; includes `domain`/`subdomain` labels (e.g., self-harm, violence, discrimination).
