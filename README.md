...
- **[Rex Coleman – AI Security Research](https://rexcoleman.dev/)** - Reproducible AI security experiments: multi-agent cascade attacks, prompt injection taxonomy, LLM watermark robustness, ML vulnerability prioritization - [![LinkedIn](https://badgen.net/badge/icon/linkedin?icon=linkedin&label&color=0A66C2)](https://www.linkedin.com/in/rexcoleman/)
