...
- **[DoD CDAO — Responsible AI Toolkit (RAI)](https://www.ai.mil/Latest/Blog/Article-Display/Article/3940314/responsible-ai-toolkit/)** — self-evaluation toolkit for AI projects across the lifecycle (Intake → Use). Includes SHIELD assessment, Statements of Concern worksheet, RASCI guidance, and a curated “RAI Tools List.” ([Webapp](https://rai.acqbot.com/))
- **[DoD — AI Guide on Risk (DAGR)](https://rai.acqbot.com/executive-summary)** — DoD-specific risk identification resource that underpins the RAI Toolkit’s SHIELD assessment; helps teams enumerate and prioritize AI risks early and feeds future DoD AI RMF work.
- **[DoD — AI Guide on Risk (DAGR)](https://rai.acqbot.com/executive-summary)** — DoD-specific risk identification resource that underpins the RAI Toolkit’s SHIELD assessment; helps teams enumerate and prioritize AI risks early. ([RAI Toolkit](https://rai.acqbot.com/) • [Appendix 1](https://www.ai.mil/Portals/137/Documents/Resources%20Page/2024-12GenAI-Responsible-AI-Toolkit.pdf))
