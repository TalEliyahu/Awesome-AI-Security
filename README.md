...
- **[SecLens](https://github.com/mattersec-labs/seclens)** [![GitHub Repo stars](https://img.shields.io/github/stars/mattersec-labs/seclens?logo=github&label=&style=social)](https://github.com/mattersec-labs/seclens) - 406 CVE-grounded tasks across 5 stakeholder lenses (developer, reviewer, triager, red-teamer, researcher); evaluates 12 LLMs on vulnerability detection, root-cause analysis, and exploitability assessment. [Dataset+Benchmark] [arXiv](https://arxiv.org/abs/2604.01637)
