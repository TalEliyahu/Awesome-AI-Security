...
- **[AI Act Companion](https://github.com/JKasteele/ai-act-companion)** - open-source, local-first EU AI Act self-assessment: cites the Article/Annex per verdict and adds an AI-security lens (OWASP LLM Top 10, MITRE ATLAS, STRIDE) with a red-team test plan and matching controls. ([Live demo](https://huggingface.co/spaces/JesseKasteele/ai-act-companion))
