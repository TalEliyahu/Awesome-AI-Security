...
- **[Future AGI Protect](https://github.com/future-agi/future-agi)** [![GitHub Repo stars](https://img.shields.io/github/stars/future-agi/future-agi?logo=github&label=&style=social)](https://github.com/future-agi/future-agi) - Multimodal guardrails for LLM/agent apps: runtime detection of prompt injection, jailbreak, PII, and toxicity across text, image, and audio.
