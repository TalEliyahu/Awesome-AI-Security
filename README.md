...
- **[TealTiger](https://github.com/agentguard-ai/tealtiger)** [![GitHub Repo stars](https://img.shields.io/github/stars/agentguard-ai/tealtiger?logo=github&label=&style=social)](https://github.com/agentguard-ai/tealtiger) - Deterministic runtime governance engine for AI agents: parallel policy evaluation (most-restrictive-wins), secret detection (500+ patterns), tool/model allowlisting, memory governance, circuit breakers, cost budgets, and SARIF/JUnit evidence export. No LLM in the decision path. TypeScript + Python SDKs.
