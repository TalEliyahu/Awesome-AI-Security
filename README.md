...
- **[emisar](https://github.com/AndrewDryga/emisar)** [![GitHub Repo stars](https://img.shields.io/github/stars/AndrewDryga/emisar?logo=github&label=&style=social)](https://github.com/AndrewDryga/emisar) — MCP control plane that limits infrastructure agents to defined actions, checks access and policy, supports approvals, revalidates requests on-host, and records outcomes.
