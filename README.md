...
- **[Aribot](https://github.com/aristiun/aribot-mcp)** [![GitHub Repo stars](https://img.shields.io/github/stars/aristiun/aribot-mcp?logo=github&label=&style=social)](https://github.com/aristiun/aribot-mcp) - Remote MCP server that runs security work from an assistant: STRIDE/LINDDUN threat modeling from a design or repo, code, CI/CD and cloud scanning, shadow-AI and API discovery, and compliance checks against NIST, ISO 27001 and SOC 2 - each finding mapped to a control and a remediation. Every tool call is scoped by OAuth 2.1, RBAC, tenant and licence. [[aribot.ayurak.com](https://aribot.ayurak.com)]
